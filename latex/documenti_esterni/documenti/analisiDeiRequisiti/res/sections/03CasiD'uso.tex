...
\item \item \textbf{estensione:} UC4-Visualizzazione Errore.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Attore principale:} Issuer (fisico).
    \item \textbf{Attore secondario:} Issuer (sistema), Holder 
...
\begin{itemize}
    \item \textbf{Attore principale:} Issuer (sistema).
    \item \textbf{Precondizioni:} Il caso d'uso da cui estende si trova in una situazione di errore.
    \item \textbf{Postcondizioni:} Viene visualizzato un errore a schermo. 
