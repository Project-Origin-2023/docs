...
\includegraphics[scale = 0.15]{./res/img/microservizi.png}
...
\includegraphics[scale=0.1]{./res/img/backendissuer.png}
\begin{itemize}
...
\includegraphics[scale=0.08]{./res/img/frontendissuer.png}
\begin{itemize}
...
\includegraphics[scale=0.1]{./res/img/backendwallet.png}
\begin{itemize}
    \item \textbf{authentication:}È una classe che si occupa della autenticazione, ovvero: login, registrazione. 
...
\includegraphics[scale=0.08]{./res/img/frontendwallet.png}
\begin{itemize}
...
\includegraphics[scale=0.08]{./res/img/frontendverifier.png}
\begin{itemize}
    \item \textbf{App:} questa è la pagina iniziale dell'applicazione, dove viene definito il \textit{routing} delle pagine.
...
\begin{center}
    \includegraphics[scale = 0.3]{./res/img/MVVM.png}
  \end{center}
