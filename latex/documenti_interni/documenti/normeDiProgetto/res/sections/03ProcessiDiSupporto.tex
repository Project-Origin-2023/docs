...
e le sezioni utilizzate, ed infine la cartella \code{config} contenente la caonfigurazione specifica del documento che instanzia il template.\\
...
Le rispettive cartelle sono \code{docs/documenti\_esterni} e \code{docs/documenti\_interni} anchesse per ciascuna ripartite in documenti e verbali.\\
